  ...
  CS2Inventory.init(
    {
      ...
      has2025ServiceMedal: {
        ...
        defaultValue: false,
        field: "has_2025_service_medal",
      },
      hasPremierSeasonOneMedal: {
        type: DataTypes.BOOLEAN,
        defaultValue: false,
        field: "has_premier_season_one_medal",
      },
      hasPremierSeasonTwoMedal: {
        type: DataTypes.BOOLEAN,
        defaultValue: false,
        field: "has_premier_season_two_medal",
      },
      processingTimeMs: {
        type: DataTypes.INTEGER,
        allowNull: true,
